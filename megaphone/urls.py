...
urlpatterns = [
    ...
    url(r'^logout$', userView.log_out_view, name='logout'),
    ...
    url(r'^domainAdmin/announcement$', domainView.DomainHomeView.as_view(), name='domain admin home'),
    url(r'^domainAdmin/event$', domainView.DomainHomeEventView.as_view(), name="domain admin home's event page"),
    url(r'^pageAdmin/announcement$', pageView.PageHomeView.as_view(), name='domain admin home'),
